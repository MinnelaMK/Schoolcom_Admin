...
public class Class_Deleted 
{
	...
	
	{
		...
		driver.get("http://tabdev.schoolcom.in/new/#/login");
			...
			driver.findElement(By.xpath("//div[1]/div/div/div/div/nb-layout-column/ngx-classes/div/div/nb-card/nb-card-body/table/tbody/tr[6]/td[4]/app-action-buttons/button")).click();
			Thread.sleep(1000);
