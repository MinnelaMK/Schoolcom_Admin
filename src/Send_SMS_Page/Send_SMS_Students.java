...
public class Send_SMS_Students 
{
	static
	{
	...
	private WebDriver driver = new ChromeDriver();
		...
		@Test(priority=1,invocationCount=1)
			...
			public void editCustomer()throws InterruptedException 
			{
				...
				driver.findElement(By.id("nb-option-3")).click();  /* Select Send to Students */
				Thread.sleep(1000);
				...
				driver.findElement(By.id("nb-option-14")).click(); /* Select the Template */
				Thread.sleep(200);
				...
				driver.findElement(By.id("nb-option-106")).click(); /* Select Class */
				Thread.sleep(200);
				
				driver.findElement(By.xpath("//div[2]/div[4]/nb-select/button")).click();  /* Select Section */
				Thread.sleep(200);
				
				driver.findElement(By.id("nb-option-115")).click();
				Thread.sleep(200);
				...
				driver.findElement(By.xpath("//div[2]/div/div/nb-option-list/ul/nb-option[1]")).click(); Thread.sleep(200);
				driver.findElement(By.xpath("//div[2]/div/div/nb-option-list/ul/nb-option[2]")).click(); Thread.sleep(200);
				driver.findElement(By.xpath("//div[2]/div/div/nb-option-list/ul/nb-option[3]")).click(); Thread.sleep(200);
				driver.findElement(By.xpath("//div[2]/div/div/nb-option-list/ul/nb-option[4]")).click(); Thread.sleep(200);
				driver.findElement(By.xpath("//div[2]/div/div/nb-option-list/ul/nb-option[5]")).click(); Thread.sleep(1000);
