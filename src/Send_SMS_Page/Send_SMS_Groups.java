		...
		public void SMSTeacher()throws InterruptedException 
			{
				...
				driver.findElement(By.xpath("//div[2]/div/div/nb-option-list/ul/nb-option[6]")).click();  /* Select Send to Teachers */
				Thread.sleep(1000);
				...
				driver.findElement(By.xpath("//div[2]/div/div/nb-option-list/ul/nb-option[8]")).click();
				Thread.sleep(200);
