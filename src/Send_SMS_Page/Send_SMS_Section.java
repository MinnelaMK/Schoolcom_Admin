	...
	private WebDriver driver = new ChromeDriver();
		...
		@Test(priority=1,invocationCount=1)
			...
			public void editCustomer()throws InterruptedException 
			{
				...
				driver.findElement(By.id("nb-option-2")).click();  /* Select Send to Sections */
				Thread.sleep(1000);
				...
				driver.findElement(By.id("nb-option-11")).click(); /* Select the Template */
				Thread.sleep(200);
