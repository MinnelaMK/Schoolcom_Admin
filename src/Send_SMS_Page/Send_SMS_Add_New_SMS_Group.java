...
public class Send_SMS_Add_New_SMS_Group 
{
	static
	{
		...
		public void SMSTeacher()throws InterruptedException 
			{
				...
				driver.findElement(By.id("groupName")).sendKeys("Lanisters");
				Thread.sleep(200);
				
				WebElement Number = driver.findElement(By.xpath("//input[@type='number']"));
				Thread.sleep(200);
				Number.sendKeys("7894561330",Keys.ENTER);
				Number.sendKeys("8457963110",Keys.ENTER);
				Number.sendKeys("8457963111",Keys.ENTER);
				Thread.sleep(1000);
