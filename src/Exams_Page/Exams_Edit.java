	...
	private WebDriver driver = new ChromeDriver();
		...
		@Test(priority=1,invocationCount=1)
			...
			public void editCustomer()throws InterruptedException 
			{
				...
				driver.findElement(By.xpath("//div[1]/div/div/div/div/nb-layout-column/ngx-exams/div/div/nb-card/nb-card-body/table/tbody/tr[1]/td[2]/app-action-buttons/button")).click();
				Thread.sleep(1000);
				
				driver.findElement(By.xpath("//a[@title='Edit']")).click();
				Thread.sleep(1000);
				
				driver.findElement(By.id("examName")).clear();
				Thread.sleep(1000);
				
				driver.findElement(By.id("examName")).sendKeys("Test June Auto Exam - 1");
				Thread.sleep(1000);
