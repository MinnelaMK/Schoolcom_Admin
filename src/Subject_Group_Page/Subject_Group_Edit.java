...
public class Subject_Group_Edit 
{
	static
	{
	...
	@Test(priority=1,invocationCount=1)
		...
		public void editCustomer()throws InterruptedException 
		{
			...
			driver.findElement(By.xpath("//div/div/nb-card/nb-card-body/table/tbody/tr[23]/td[3]/app-action-buttons/button")).click();
			Thread.sleep(500);
			
			driver.findElement(By.xpath("//nb-context-menu/nb-menu/ul/li[1]/a")).click();
			Thread.sleep(1000);
			
			driver.findElement(By.id("subjectGroup")).clear();
			Thread.sleep(500);
			
			driver.findElement(By.id("subjectGroup")).sendKeys("Auto");
			Thread.sleep(500);
			
			String Text = driver.findElement(By.id("subjectGroup")).getAttribute("value");
	        System.out.println("Existing text field data: " + Text);
			
			driver.findElement(By.xpath("//button/span")).click();
			Thread.sleep(1000);
		
			driver.findElement(By.xpath("//nb-option[11]")).click();
			Thread.sleep(1000);
			
			driver.findElement(By.xpath("//nb-option[12]")).click();
			Thread.sleep(1000);
			
			driver.findElement(By.xpath("//nb-option[13]")).click();
			Thread.sleep(1000);
			
			driver.findElement(By.xpath("//nb-option[14]")).click();
			Thread.sleep(1000);
			
			driver.findElement(By.xpath("//nb-option[15]")).click();
			Thread.sleep(1000);
